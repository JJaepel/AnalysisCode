...
analysisParams.plotROIs = 1;   %should you plot traces for all ROIs?
analysisParams.reloadData = 0; %should you reload from suite2p and do baselining?
...
if analysisParams.server
    ...
    [~, xls_txt, xls_all]=xlsread('F:\Organization\Animals\2pExpByStimulus.xlsx', 'driftingGrating_ori_tf');
end
