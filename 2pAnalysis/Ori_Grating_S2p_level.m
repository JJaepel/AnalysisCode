function Ori_Grating_S2p_level(animal, expt_id, sp2id, name, reloadData, plotROIs)
...
function [data]= Load_rois(sliceparams)
    ...
    elseif size(Suite2p.opsmeanImg,2) == 1536
        ...
        try
           if type == 1
            ...
            elseif type == 2
                ...
                plot(xpos,ypos,'ok','MarkerSize',sizeMarker,'MarkerFaceColor',LUT(analysis.(field).roi(l).prefTfStim,:));
            elseif type == 3
