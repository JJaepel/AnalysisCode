function Patches_S2p_level(animal, expt_id, sp2id, name, reloadData, plotROIsResps, special)

%animal = 'F2360_2019-09-10'; 
%expt_id = 't00068';
%sp2id = expt_id;
%name = 'white';
%reloadData = 0;
...
switch Stimtype
    ...
    case 'azimuthBars'
        ...
        metadata.StimParams.numPatches = metadata.StimParams.numElevation*metadata.StimParams.numAzimuth;
        metadata.StimParams.stimPosX = linspace(metadata.StimParams.startAzim,metadata.StimParams.stimSize(1)*metadata.StimParams.numAzimuth+metadata.StimParams.startAzim,metadata.StimParams.numAzimuth);
    ...
    case 'RF_local'
        ...
        metadata.StimParams.numPatches = metadata.StimParams.numElevation*metadata.StimParams.numAzimuth;
        metadata.StimParams.stimPosX = linspace(metadata.StimParams.startAzim,metadata.StimParams.stimSize(2)*metadata.StimParams.numAzimuth+metadata.StimParams.startAzim,metadata.StimParams.numAzimuth);
        metadata.StimParams.stimPosY = 1;
        onlyAzi = 1;
end
