...
analysisParams.plotROIs = 0;   %should you plot traces for resp ROIs?
...
if analysisParams.server
    [~, xls_txt, xls_all]=xlsread('Z:\Juliane\Organization\Animals\2pExpByStimulus.xlsx', 'Retinotopy');
else
