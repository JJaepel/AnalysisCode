 function [xCurrent,Resnorm,FVAL,EXITFLAG,OUTPUT,LAMBDA,JACOB] = lsqcurvefit_v2019a(FUN,xCurrent,XDATA,YDATA,LB,UB,options,varargin)
...
%
%   See also OPTIMOPTIONS, LSQNONLIN, FSOLVE, @, INLINE.
...
if ~isempty( isoptimargdbl('LSQCURVEFIT', {'F','J'}, initVals.F, initVals.J) )
    error('optimlib:lsqcurvefit:NonDoubleFunVal',getString(message('optimlib:commonMsgs:NonDoubleFunVal','LSQCURVEFIT')));
end
