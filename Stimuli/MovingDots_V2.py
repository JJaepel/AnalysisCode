...
# create grating stim
dotPatch = visual.ElementArrayStim(win = myWin, colors = (-1.0, -1.0, -1.0), units = 'deg', fieldShape='circle',
                                   fieldSize=60, nElements=30, contrs=1)
