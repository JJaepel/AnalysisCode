...
blankpercent = 0.1 # if specific percent of stims should be blank
if blankpercent > 0:
    nBlank = int(math.floor(numOrientations * blankpercent))
...
centerPoint = [0, 0]
stimSize = [20, 20]  # Size of grating in degrees
...
duration = initialDelay + numTrials * numOrientations * (isi + stimDuration) + numTrials * nBlank
